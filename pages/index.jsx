...
<div className="py-10">
  <Link href="#">
    <a className=" px-6 justify-center gap-x-2 shadow-lg shadow-amber-600/20 rounded-xl py-4 font-medium bg-gradient-to-bl from-amber-700 to-amber-500 hover:opacity-80 transition duration-300 text-white ">
      Kontrol Paneli
    </a>
  </Link>
</div>
